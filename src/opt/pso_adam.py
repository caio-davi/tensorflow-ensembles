...
class pso:
    def __init__(
        ...
        self.gd_alpha = gd_alpha * tf.math.sqrt(1 - self.beta_2) / (1 - self.beta_1)
    ...
    def remove_outliers(self):
        ...
        self.m1 = tf.boolean_mask(self.m1, selection_mask)
        self.m2 = tf.boolean_mask(self.m2, selection_mask)
    ...
    def gradient_descent(self):
        ...
        self.m2 = self.beta_2 * self.m2 + (1 - self.beta_2) * tf.math.square(self.grads)
        return self.gd_alpha * self.m1 / tf.math.sqrt(self.m2) + 1e-7
